        ...
        <div className="container px-5 py-10 mx-auto">
          <div className="text-center mb-20">
            ...
            <div className="flex mt-6 justify-center">
              <div className="w-20 h-1 rounded-full bg-emerald-500 inline-flex"></div>
            </div>
          </div>
          <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
            <div className="p-4 md:w-1/3 flex flex-col text-justify items-center">
              <div className="w-20 h-20 inline-flex items-center justify-center rounded-full bg-emerald-100 text-emerald-500 mb-5 flex-shrink-0">
                <Image
                  alt="icon"
                  src={pic1}
            ...
            <div className="p-4 md:w-1/3 flex flex-col text-justify items-center">
              <div className="bg-white bg-none w-20 h-20 inline-flex items-center justify-center rounded-full bg-emerald-100 text-emerald-500 mb-5 flex-shrink-0">
                <Image
                  alt="icon"
                  src={pic2}
                  className="rounded-full bg-white"
            ...
            <div className="p-4 md:w-1/3 flex flex-col text-justify items-center">
              <div className="bg-white w-20 h-20 inline-flex items-center justify-center rounded-full bg-emerald-100 text-emerald-500 mb-5 flex-shrink-0">
                <Image
                  alt="icon"
                  src={pic3}
                  className="rounded-full bg-white"
              ...
              <div className="flex-grow">
                <h2 className="bg-white text-gray-900 text-lg text-center title-font font-medium mb-3">
                  Tailwind
                </h2>
                <p className="leading-relaxed text-base">
            ...
            <div className="p-4 md:w-1/3 flex flex-col text-justify items-center">
              <div className="bg-white w-20 h-20 inline-flex items-center justify-center rounded-full bg-emerald-100 text-emerald-500 mb-5 bg-none flex-shrink-0">
                <Image
                  alt="icon"
                  src={pic6}
                  className="rounded-full bg-white"
